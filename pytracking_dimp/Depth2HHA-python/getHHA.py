...
def getImage(root='demo'):
    D = cv2.imread(os.path.join(root, 'd-0-1.png'), cv2.COLOR_BGR2GRAY)/10000
    RD = cv2.imread(os.path.join(root, 'd-0-1.png'), cv2.COLOR_BGR2GRAY)/10000
    return D, RD
...
if __name__ == "__main__":
    ...
    camera_matrix[0,0]=575.8157496
    camera_matrix[1,1]=575.8157496
