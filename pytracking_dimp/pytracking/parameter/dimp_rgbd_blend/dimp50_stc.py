...
def parameters():
    ...
    params.augmentation_expansion_factor = 5
    params.random_shift_factor = 1/3

    # Advanced localization parameters
    params.advanced_localization = True
    params.target_not_found_threshold = 0.0#0.35#0.25
    ...
    #params.net = NetWithBackbone(net_path='DiMPnet_rgbd_blend0_ep0016.pth.tar', use_gpu=params.use_gpu)
    #params.net = NetWithBackbone(net_path='DiMPnet_rgbd_blend1_ep0016.pth.tar', use_gpu=params.use_gpu)
