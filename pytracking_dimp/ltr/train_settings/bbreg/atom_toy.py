...
from ltr.dataset import Lasot, TrackingNet, MSCOCOSeq, PrincetonRGBD
...
def run(settings):
    ...
    # Validation datasets
    trackingnet_val = Lasot(split='train')#TrackingNet(set_ids=list(range(11,12)))
    ...
    dataset_train = sampler.ATOMSampler([lasot_train,ptb_train], [1,1],
    ...
    # Optimizer
    optimizer = optim.Adam(actor.net.bb_regressor.parameters(), lr=1e-5)
    ...
    trainer.train(1, load_latest=True, fail_safe=False)#, path_pretrainedatom='./checkpoints/atom_default.pth')
