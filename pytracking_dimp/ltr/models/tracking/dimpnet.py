...
def dimpnet18(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
    ...
    # DiMP network
    net = DiMPnet(settings=settings, feature_extractor=backbone_net, classifier=classifier, bb_regressor=bb_regressor,
