...
class AtomIoUNet_rgbd(nn.Module):
    ...
    def __init__(self, input_dim=(128,256), pred_input_dim=(256,256), pred_inter_dim=(256,256)):
        ...
        self.conv3_1r_0 = conv(input_dim[0], int(input_dim[0]/2), kernel_size=3, stride=1)
        self.conv3_1t_0 = conv(input_dim[0], int(input_dim[0]/2), kernel_size=3, stride=1)

        # _r for reference, _t for test
        self.conv3_1r = conv(int(input_dim[0]/2), 128, kernel_size=3, stride=1)
        self.conv3_1t = conv(int(input_dim[0]/2), 256, kernel_size=3, stride=1)
        ...
        self.conv4_1r_0 = conv(input_dim[1], int(input_dim[1]/2), kernel_size=3, stride=1)
        self.conv4_1t_0 = conv(input_dim[1], int(input_dim[1]/2), kernel_size=3, stride=1)

        self.conv4_1r = conv(int(input_dim[1]/2), 256, kernel_size=3, stride=1)
        self.conv4_1t = conv(int(input_dim[1]/2), 256, kernel_size=3, stride=1)
    ...
    def get_modulation(self, feat, bb):
        ...
        c3_r = self.conv3_1r(self.conv3_1r_0(feat3_r))
        ...
        c4_r = self.conv4_1r(self.conv4_1r_0(feat4_r))
    ...
    def get_iou_feat(self, feat2):
        ...
        c3_t = self.conv3_2t(self.conv3_1t(self.conv3_1t_0(feat3_t)))
        c4_t = self.conv4_2t(self.conv4_1t(self.conv4_1t_0(feat4_t)))
